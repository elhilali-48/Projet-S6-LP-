          ...
          <div class="row text-center">
            <div class="col-md-4 ">
              ...
              <div class="card bg-info text-black mt-3 " style="border-radius: 7px">
                  ...
                  <div class="card-body">
                     <b style="font-size: 25px"> {{$etudiant_droit}}</b>
                  </div>
              </div>
           </div>
           <div class="col-md-4  ">
            ...
            <div class="col-md-12 mt-4 ">
                <div class="card bg-light  text-black" style="border-radius: 7px">
                    <div class="card-header text-enter "><h5 class="font-weight-bold font-italic">Etudiant : Droit
                      <div class="form-inline ml-3  float-right">
                        
                        <form method="GET" action="{{route('droit.filter')}}" class="form-inline ml-3 float-right">
                        ...
                        <form method="GET" action="{{route('etudiants.droit')}}" class="form-inline ml-3 float-right">

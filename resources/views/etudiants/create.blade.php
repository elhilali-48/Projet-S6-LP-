...
<div class="col-md-12">
    ...
    @if (session()->has('success'))
          <div style="border-radius: 7px" class="alert alert-success alert-dismissible fade show " role='alert' >
...
<div class="card card-default col-md-12 ">
    ...
    <div class="card-header ">
       <h4 class="font-weight-bold d-flex justify-content-center"> Ajouter un étudiant</h4>
    </div>
    <div class="card-body ">
        
            <form action="{{route('etudiantt.store')}}" method="POST" >
                @csrf
                <div class="row">
                        <div class="col-md-4">
                        <div class="form-group">
                            <label for="nom" class="">Nom  : </label>
                        <input class="@error('nom') is-invalid @enderror form-control" id="nom" name="nom" placeholder="Ecrire le nom de l'étudiant" value="{{old('nom') }}" >
                            @error('nom')
                        ...
                        <div class="form-group">
                            ...
                            <input class="@error('prenom') is-invalid @enderror form-control" id="prenom" name="prenom" placeholder="Ecrire le prénom de l'étudiant" value="{{old('prenom') }}" >
                            @error('prenom')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="@error('Apogee') is-invalid @enderror form-control" id="Apogee" name="Apogee" placeholder="Ecrire l'Apogée de l'étudiant" value="{{old('Apogee') }}" >
                            @error('Apogee')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="@error('CNE') is-invalid @enderror form-control" id="CNE" name="CNE" placeholder="Ecrire le code national de l'étudiant" value="{{old('CNE') }}" >
                            @error('CNE')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="@error('CIN') is-invalid @enderror form-control" id="CIN" name="CIN" placeholder="Ecrire le code d'identité de l'étudiant" value="{{old('CIN') }}" >
                            @error('CIN')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input id="date" type="date" class="@error('date') is-invalid @enderror form-control " name="date" max="2004-01-01" min="1950-01-01" value="{{old('date') }}"   placeholder="Saisissez votre date de naissance">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="@error('email') is-invalid @enderror form-control" id="email" name="email" placeholder="Ecrire l'email  de l'étudiant" value="{{old('email') }}" >
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

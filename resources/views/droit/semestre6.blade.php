        ...
        <div class="col-md-12">
            <script>
                ...
                <nav class="nav nav-tabs" id="myTab">
                    <a class="nav-item nav-link" href="#p1" data-toggle="tab">Semestre 6</a>
                    <a class="nav-item nav-link" href="#p2" data-toggle="tab">Droit Public</a>
                    <a class="nav-item nav-link" href="#p3" data-toggle="tab">Droit Privée-SA</a>
                    <a class="nav-item nav-link" href="#p4" data-toggle="tab">Droit Privée-SB</a>
                    <a class="nav-item nav-link" href="#p5" data-toggle="tab">Droit Privée-SC</a>
                                        ...
                                        <div class="table-responsive" >
                                            <table class="table table-striped table-hover " >
                                                <thead style="width: 100%">
                                                  ...
                                                  <tbody>
                                                    @forelse ($etudiant_Droit_Public as $etudiant)
                                                    ...
                                                    <td colspan="12" class="text-danger text-center"> Aucune Etudiant Existe 
                                                        <a class="btn btn-info " colspan="12"  href="{{route('droit.semestre6')}}">Retour</a></td>
                                                    @endforelse
                                        ...
                                        <div class="table-responsive" >
                                            <table class="table table-striped table-hover " >
                                                <thead style="width: 100%">
                                                  ...
                                                  <tbody>
                                                    @forelse ($etudiant_Droit_Privee_SA as $etudiant)
                                                    @if (!$etudiant->deleted_at)
                                                    <tr class="table-info">
                                                    <th scope="row">{{$etudiant->Apogee}}</th>
                                                        <td>{{$etudiant->Nom}}</td>
                                        ...
                                        <div class="table-responsive" >
                                            <table class="table table-striped table-hover " >
                                                <thead style="width: 100%">
                                                  ...
                                                  <tbody>
                                                    @forelse ($etudiant_Droit_Privee_SB as $etudiant)
                                                    @if (!$etudiant->deleted_at)
                                                    <tr class="table-info">
                                                    <th scope="row">{{$etudiant->Apogee}}</th>
                                                        <td>{{$etudiant->Nom}}</td>
                                        ...
                                        <div class="table-responsive" >
                                            <table class="table table-striped table-hover " >
                                                <thead style="width: 100%">
                                                  ...
                                                  <tbody>
                                                    @forelse ($etudiant_Droit_Privee_SC as $etudiant)
                                                    @if (!$etudiant->deleted_at)
                                                    <tr class="table-info">
                                                    <th scope="row">{{$etudiant->Apogee}}</th>
                                                        <td>{{$etudiant->Nom}}</td>

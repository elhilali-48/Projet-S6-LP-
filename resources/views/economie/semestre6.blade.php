    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <script>
                ...
                <a class="nav-item nav-link active" href="#p1" data-toggle="tab">Semestre 6</a>
                <a class="nav-item nav-link  " href="#p2" data-toggle="tab" >Economie et Gestion</a>
                <a class="nav-item nav-link" href="#p3" data-toggle="tab" >Gestion </a>
                                        ...
                                        <div class="table-responsive" >
                                            <table class="table table-striped table-hover " >
                                                <thead style="width: 100%">
                                                  ...
                                                  <tbody>
                                                    @forelse ($etudiant_ECO_GES as $etudiant)
                                        ...
                                        <div class="table-responsive" >
                                            <table class="table table-striped table-hover " >
                                                <thead style="width: 100%">
                                                  ...
                                                  <tbody>
                                                    @forelse ($etudiant_GES as $etudiant)
                                                    @if (!$etudiant->deleted_at)
                                                    <tr class="table-info">
                                                    <th scope="row">{{$etudiant->Apogee}}</th>
                                                        <td>{{$etudiant->Nom}}</td>

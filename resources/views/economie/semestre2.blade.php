        ...
        <div class="col-md-12">
            <script>
                ...
                {{-- <nav class="nav nav-tabs">
                    <a class="nav-item nav-link active " href="#p1" data-toggle="tab">Semestre 2</a>
                <a class="nav-item nav-link" href="{{route('semestre2.sectionA')}}" >Section A</a>
                    <a class="nav-item nav-link" href="{{route('semestre2.sectionB')}}">Section B</a>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <th scope="row">{{$etudiant->Apogee}}</th>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="float-right" ><a href="{{route('etudiantt.edit',$etudiant->id)}}" title="Editer"><i class="fas fa-edit fa-md ml-1" style="color:rgb(238, 241, 6)"></i></a></span>                                                            <span class="float-right" ><a href="{{route('etudiant.affiche',$etudiant->id)}}"><i class="fas fa-eye mr-2" style="color: blue"></i></a></span>
                                                            @endif
                                                    ...
                                                    <td colspan="12" class="text-danger text-center"> Aucune Etudiant Existe 
                                                        <a class="btn btn-info " colspan="12"  href="{{route('economie.semestre2')}}">Retour</a></td>
                                                    @endforelse
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <th scope="row">{{$etudiant->Apogee}}</th>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (Auth::user()->isAdmin())
                                                            <span class="float-right" ><a href="{{route('etudiantt.edit',$etudiant->id)}}" title="Editer"><i class="fas fa-edit fa-md ml-1" style="color:rgb(238, 241, 6)"></i></a></span>                                                       
